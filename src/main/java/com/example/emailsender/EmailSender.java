...
public class EmailSender {
    ...
    private static final String SMTP_AUTH_USER = "dhanushjayadevan274@gmail.com"; // Your email
    private static final String SMTP_AUTH_PWD = "uwdf ypsx svuw brnk";   // Your email password
